...
_HARDCODED_SIGNS = {
    "HELLO": [
        _f(270, 250, _OPEN_HAND, desc="Hand rises from side"),
        _f(280, 180, _OPEN_HAND, desc="Hand approaches forehead"),
        _f(290, 150, _OPEN_HAND, desc="Open hand at forehead, palm out"),
        _f(320, 140, _OPEN_HAND, desc="Wave outward"),
        _f(345, 150, _OPEN_HAND, desc="Wave reaches side"),
        _f(330, 160, _OPEN_HAND, desc="Settle"),
    ],
    "THANK-YOU": [
        _f(240, 280, _FLAT_HAND, desc="Hand rises from chest"),
        _f(225, 210, _FLAT_HAND, desc="Hand approaches chin"),
        _f(220, 190, _FLAT_HAND, desc="Flat hand touches chin"),
        _f(250, 220, _FLAT_HAND, desc="Hand moves outward from chin"),
        _f(290, 260, _FLAT_HAND, desc="Hand extends forward"),
        _f(310, 280, _FLAT_HAND, desc="Complete — thank you"),
    ],
    "YES": [
        _f(280, 230, _S_FIST, desc="Fist rises"),
        _f(280, 195, _S_FIST, desc="Fist at top"),
        _f(280, 240, _S_FIST, desc="Nod down"),
        _f(280, 195, _S_FIST, desc="Nod back up"),
        _f(280, 240, _S_FIST, desc="Nod down again"),
    ],
    "NO": [
        _f(280, 230, _W_HAND, desc="Hand rises, fingers open"),
        _f(280, 200, _W_HAND, desc="Index+middle extended out"),
        _f(280, 200, _H_HAND, desc="Fingers begin closing to thumb"),
        _f(280, 200, _S_FIST, desc="Fingers snap shut — NO"),
        _f(280, 210, _S_FIST, desc="Hold closed"),
    ],
    "PLEASE": [
        _f(220, 310, _FLAT_HAND, desc="Hand at lower chest"),
        _f(210, 275, _FLAT_HAND, desc="Hand circles up-left on chest"),
        _f(230, 260, _FLAT_HAND, desc="Circle continues up-right"),
        _f(245, 285, _FLAT_HAND, desc="Circle goes down-right"),
        _f(220, 310, _FLAT_HAND, desc="Complete circle — please"),
    ],
    "HELP": [
        _f(200, 340, _S_FIST, 200, 310, _FLAT_HAND, desc="Fist rests on open palm"),
        _f(200, 310, _S_FIST, 200, 290, _FLAT_HAND, desc="Both hands rise together"),
        _f(200, 280, _S_FIST, 200, 260, _FLAT_HAND, desc="Rising higher"),
        _f(200, 260, _S_FIST, 200, 240, _FLAT_HAND, desc="Reach top — help"),
    ],
    "WATER": [
        _f(230, 220, _W_HAND, desc="W-hand approaches chin"),
        _f(225, 190, _W_HAND, desc="W taps chin"),
        _f(230, 200, _W_HAND, desc="Lift slightly"),
        _f(225, 190, _W_HAND, desc="Tap chin again — water"),
    ...
    "HAPPY": [
        _f(230, 300, _FLAT_HAND, 170, 300, _FLAT_HAND, desc="Both hands at lower chest"),
        _f(230, 280, _FLAT_HAND, 170, 280, _FLAT_HAND, desc="Brush upward"),
        _f(235, 255, _FLAT_HAND, 165, 255, _FLAT_HAND, desc="Sweep up higher"),
        _f(230, 240, _FLAT_HAND, 170, 240, _FLAT_HAND, desc="Reach top — happy"),
        _f(235, 250, _FLAT_HAND, 165, 250, _FLAT_HAND, desc="Bounce back slightly"),
    ],
    "SORRY": [
    ...
    "LOVE": [
        _f(240, 310, _ILY, desc="ILY hand rises from chest"),
        _f(230, 280, _ILY, desc="ILY handshape at chest"),
        _f(225, 260, _ILY, desc="Hold — I Love You"),
        _f(230, 270, _ILY, desc="Settle"),
    ],
    "FOOD": [
